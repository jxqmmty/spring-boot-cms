					...
					<div class="modal fade" id="saveModal">
					  <div class="modal-dialog">
					    <div class="modal-content message_align">
					      ...
					      <div class="modal-body">
					        <form action="/system/faq/addOrUpt" method="post" class="form-horizontal" id="saveForm">
					          <input type="hidden" name="id">
					          <div class="form-group row">
					            <label for="title" class="control-label col-md-3">问题标题</label>
					            <div class="col-md-9">
					          ...
					          <div class="form-group row">
					            <label for="orderBy" class="control-label col-md-3">问题排序</label>
					            <div class="col-md-9">
					              <input class="form-control" type="number" name="orderBy">
					            </div>
					          </div>
					          <div class="form-group row">
			...
			$(function() {
				...
				$("body").on("click","a[data-id]",function(){
					...
					$("#delModelButton").click(function() {
						// 发送请求
						$.get("/system/faq/remove","id="+id,function(result){
							if (result.success) {
								// 关闭模态框
								$("#delModal").modal("hide");
								// 刷新列表

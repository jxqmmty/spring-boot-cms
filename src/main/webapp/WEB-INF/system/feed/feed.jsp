					  ...
					  <div class="modal-dialog">
					    <div class="modal-content message_align">
					      ...
					      <div class="modal-body">
					        <form action="/system/feed/addOrUpt" method="post" enctype="multipart/form-data" class="form-horizontal" id="saveForm">
					      ...
					      <div class="modal-footer">
					        ...
					        <a href='#' id="saveButton" class="btn btn-success" >确定</a>
					      </div>
					    </div>
					  </div>
					</div>
			...
			$(function() {
				    ...
				    columnData: [
				        {
				            ...
				            template: function(cell, row, index, key){
		    	                return "<img  src="+cell+" style='width: 45px'>";
		    	            }
				        },{
				            key: 'createDate',
				            text: '创建时间'
				...
				$("body").on("click","a[data-id]",function(){
					...
					$("#delModelButton").click(function() {
						// 发送请求
						$.get("/system/feed/remove","id="+id,function(result){
							if (result.success) {
								// 关闭模态框
								$("#delModal").modal("hide");
								// 刷新列表
